...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        ...
        fillContactForm(new ContactData("Ilya", "Levkov", "Russia, Ryazan", "+79156255826", "ilya.levkov2@gmail.com"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        wd.findElement(By.name("mobile")).sendKeys(contactData.getContactMobilePhone());
